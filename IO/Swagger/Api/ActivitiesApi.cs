...
namespace IO.Swagger.Api
{
    ...
    public interface IActivitiesApi
    {
        ...
        DetailedActivity CreateActivity (string name, string sportType, DateTime? startDateLocal, int? elapsedTime, string type, string description, float? distance, int? trainer, int? commute);
        /// <summary>
    ...
    public class ActivitiesApi : IActivitiesApi
    {
        ...
        /// <param name="commute">Set to 1 to mark as commute.</param> 
        /// <returns>DetailedActivity</returns>            
        public DetailedActivity CreateActivity (string name, string sportType, DateTime? startDateLocal, int? elapsedTime, string type, string description, float? distance, int? trainer, int? commute)
        {
            ...
            if (sportType == null) throw new ApiException(400, "Missing required parameter 'sportType' when calling CreateActivity");
...
if (sportType != null) formParams.Add("sport_type", ApiClient.ParameterToString(sportType)); // form parameter
