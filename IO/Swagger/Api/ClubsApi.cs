...
namespace IO.Swagger.Api
{
    ...
    public interface IClubsApi
    {
        ...
        List<SummaryActivity> GetClubActivitiesById (long? id, int? page, int? perPage);
        /// <summary>
        ...
        List<SummaryAthlete> GetClubAdminsById (long? id, int? page, int? perPage);
        /// <summary>
        ...
        /// <param name="perPage">Number of items per page. Defaults to 30.</param>
        /// <returns>List&lt;SummaryAthlete&gt;</returns>
        List<SummaryAthlete> GetClubMembersById (long? id, int? page, int? perPage);
        /// <summary>
    ...
    public class ClubsApi : IClubsApi
    {
        ...
        /// <param name="perPage">Number of items per page. Defaults to 30.</param> 
        /// <returns>List&lt;SummaryActivity&gt;</returns>            
        public List<SummaryActivity> GetClubActivitiesById (long? id, int? page, int? perPage)
        {
 ...
 if (perPage != null) queryParams.Add("per_page", ApiClient.ParameterToString(perPage)); // query parameter
        ...
        /// <param name="perPage">Number of items per page. Defaults to 30.</param> 
        /// <returns>List&lt;SummaryAthlete&gt;</returns>            
        public List<SummaryAthlete> GetClubAdminsById (long? id, int? page, int? perPage)
        {
 ...
 if (perPage != null) queryParams.Add("per_page", ApiClient.ParameterToString(perPage)); // query parameter
        ...
        /// <param name="perPage">Number of items per page. Defaults to 30.</param> 
        /// <returns>List&lt;SummaryAthlete&gt;</returns>            
        public List<SummaryAthlete> GetClubMembersById (long? id, int? page, int? perPage)
        {
