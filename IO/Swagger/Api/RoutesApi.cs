...
namespace IO.Swagger.Api
{
    ...
    public interface IRoutesApi
    {
        ...
        Model.Route GetRouteById (long? id);
        /// <summary>
        ...
        List<Model.Route> GetRoutesByAthleteId (int? page, int? perPage);
    }
    ...
    public class RoutesApi : IRoutesApi
    {
        ...
        /// <param name="id">The identifier of the route.</param> 
        /// <returns>Route</returns>            
        public Model.Route GetRouteById (long? id)
        {
            ...
            return (Model.Route) ApiClient.Deserialize(response.Content, typeof(Model.Route), response.Headers);
        }
        ...
        /// <param name="perPage">Number of items per page. Defaults to 30.</param> 
        /// <returns>List&lt;Route&gt;</returns>            
        public List<Model.Route> GetRoutesByAthleteId (int? page, int? perPage)
        {
 ...
 if (perPage != null) queryParams.Add("per_page", ApiClient.ParameterToString(perPage)); // query parameter
            ...
            return (List<Model.Route>) ApiClient.Deserialize(response.Content, typeof(List<Model.Route>), response.Headers);
        }
